...
<style>
 ...
 body {
        ...
        background: url(Images/progileback.png);
    }
...
<div class = "wrapper">
		...
		<h1>Add New Exchanging Book</h1><br>
		<div class="input-row">
            <div class="input-box"> 
        ...
        <div class="input-row">
            ...
            <div class="input-row">
            <div class="lable"><br>
                <label  class ="lablefix" for="image" >Image&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</label>&nbsp
