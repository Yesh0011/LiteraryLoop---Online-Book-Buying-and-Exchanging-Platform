...
<header class="header2">
    ...
    <nav class="navigation">
        ...
        <a href="viewallselbooks.jsp" >Store</a> <!-- Add "store" class to the Store link -->
    </nav>
</header><br><br>
	...
	<%
        ...
        <div class="box-container">
            <div class="box">
                <img src ="exbooks/<%=book.getImage()%>"
			 style="width:200px;height:200px;"></center><br><br><br>
                <h2><%=book.getBookname()%></h2><br>
                
                
                <a href="exbookdetails.jsp?bookid=<%=book.getBookid() %>" class="btn">Details</a>
            </div>
